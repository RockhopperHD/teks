...
const StandardPill: React.FC<StandardPillProps> = ({ standardId, definition }) => {
  ...
  return (
    <div className="group relative inline-flex flex-col items-center">
      ...
      {isValid && (
        <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-72 p-3 bg-slate-800 text-white text-xs rounded-lg shadow-xl z-50 pointer-events-none">
          <div className="font-bold mb-1 text-slate-300 border-b border-slate-600 pb-1 flex justify-between">
