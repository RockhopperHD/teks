...
Go to the CSVs folder here and send it the appropriate CSV
...
[[List these things: time available (i.e. 5 days, 1 lesson, 1 month, half unit), grade level (K, 1, 2, ... up to 8, then "HS" is 9-12), subject (MUST BE ONE OF THE FOLLOWING: career, english, esl-spanish, fine-arts, health-education, languages-other-than-english, mathematics, science, social-studies, technology-applications, texas-knowledge), details about lesson specifics (i.e. "Solar System" "Photosynthesis")
